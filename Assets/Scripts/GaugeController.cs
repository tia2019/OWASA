...
public class GaugeController : MonoBehaviour
{
    ...
    public float t2Energy, t4Energy = 0f;
    public bool t4Change, t2Change = false;
    ...
    float firstHalfVal, secondHalfVal = 0f;
    

    public void setTank2Energy(float e)
    {
        e = e*500f;
    ...
    public void setTank4Energy(float e)
    {
        e = e*500f;
        secondHalfVal = e;
        // {
     ...
     public void getEnergy ()
        {
        // Debug.Log(t4Change + "change in t 4");
        // Debug.Log(t2Change + "change in t 2");
        if (t4Change)
        {
            GaugeValue += t4Energy;
            t4Change = false;
    ...
    void Update ()
    {
        GaugeValue = firstHalfVal + secondHalfVal;   
